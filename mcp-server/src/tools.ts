...
export function registerVideonTools(server: ToolServer) {
  ...
  server.registerTool(
    'videon.projects_list',
    {
      ...
      description: 'GET /api/collections — Access Model B projects for the token owner.',
      inputSchema: z.object({}),
    },
    async () => textResult('/api/collections'),
  )
  ...
  server.registerTool(
    'videon.media_search',
    {
      title: 'Search scenes',
      description:
        'GET /api/media/search — NL scene search across accessible projects (or one platformProjectId). Returns bounded hits with editor deep links (t/scene).',
      inputSchema: z.object({
  ...
  server.registerTool(
    ...
    {
      title: 'List media',
      description: 'GET /api/media — library list (optional platformProjectId; else accessible).',
      inputSchema: z.object({
  ...
  server.registerTool(
    'videon.media_get',
    {
      ...
      description:
        'GET /api/media/:id — lifecycle, analysis status, scene index (≤40), deep links. No full transcript/stems/binaries.',
      inputSchema: z.object({
  ...
  server.registerTool(
    ...
    {
      title: 'Analysis runs',
      description: 'GET /api/analyses — run/stage status for a project (requires platformProjectId).',
      inputSchema: z.object({
        platformProjectId: z.string(),
      }),
    },
  ...
  server.registerTool(
    ...
    {
      title: 'List cuts',
      description: 'GET /api/cuts — cuts for a project.',
      inputSchema: z.object({
        platformProjectId: z.string(),
      }),
    },
  ...
  server.registerTool(
    'videon.cut_get',
    {
      ...
      description: 'GET /api/cuts/:id — cut meta; omit heavy timeline payload when possible.',
      inputSchema: z.object({
        cutId: z.string(),
        platformProjectId: z.string(),
      }),
