  ...
  return (
    <div className="videon-cut-timeline">
      <div className="videon-cut-timeline__meta">
        ...
        <Text role="meta">Ziehen zum Trimmen · Clips per Drag umsortieren</Text>
      </div>
      <div
        ref={trackRef}
        className="videon-cut-timeline__track"
      ...
      >
        ...
        <div
          ...
          style={{ left: `${totalDurationMs > 0 ? (cutPlayheadMs / totalDurationMs) * 100 : 0}%` }}
        />
      </div>
    </div>
  )
