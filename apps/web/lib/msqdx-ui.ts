...
export { IconVideo, IconMic, IconResearch, IconUser, IconText, IconBox, IconPackage, IconCar, IconPaw, IconZap, IconImage } from '../../../../msqdx-ui/packages/ui/src/components/icons'
