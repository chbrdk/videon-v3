export const paths = {
  ...
  routes: {
    ...
    apiCutClientRoomApprove: (cutId: string, platformProjectId: string) =>
      `/api/cuts/${encodeURIComponent(cutId)}/client-room-approve?platformProjectId=${encodeURIComponent(platformProjectId)}`,
