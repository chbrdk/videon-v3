...
describe('adobe uxp library panel contracts', () => {
  ...
  it('panel scaffold ships Premiere UXP manifest (host premierepro)', () => {
    ...
    expect(readFileSync(join(root, 'src/index.html'), 'utf8')).toContain('v0.1.15')
    ...
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain("PANEL_VERSION = '0.1.15'")
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain('verifyApiToken')
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain('hit-card')
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain('applyPosterToCard')
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain('applyPreviewToCard')
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain('fetchPreviewBlob')
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain('hit-insert-btn')
    expect(readFileSync(join(root, 'src/index.js'), 'utf8')).toContain('runInsert([hit.id])')
    expect(readFileSync(join(root, 'src/styles.css'), 'utf8')).toContain('hit-card-media')
    expect(readFileSync(join(root, 'src/styles.css'), 'utf8')).toContain('hit-card-preview')
    expect(readFileSync(join(root, 'src/styles.css'), 'utf8')).toContain('flex-wrap: wrap')
    expect(readFileSync(join(root, 'src/styles.css'), 'utf8')).toContain('height: 84px')
    ...
    expect(readFileSync(join(root, 'src/api.js'), 'utf8')).toContain('api/tokens/verify')
    ...
    expect(readFileSync(join(root, 'src/panel.bundle.js'), 'utf8')).toContain('0.1.15')
    expect(readFileSync(join(root, 'src/panel.bundle.js'), 'utf8')).toContain('hit-card')
    expect(readFileSync(join(root, 'src/panel.bundle.js'), 'utf8')).toContain('applyPosterToCard')
