...
1b. WHEN the Cut editor opens THEN progressive load rules in `cut-editor-load-performance.md` apply (Frame API posters, lazy thumbs, deferred waveform, deduped playback).
...
- Cut timeline: `cut-timeline-edit-ux.md` + `cut-timeline-edit-ux-wave2.md` + `cut-editor-shortcuts.md`.
